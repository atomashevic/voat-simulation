"""
core-periphery-enhanced.py - Enhanced Network Analysis with Multi-Sample Core-Periphery Detection
Builds a network representation of user interactions and performs comprehensive core-periphery detection
...
def print_header(simulation_name):
    ...
    print(f"\n{'-'*80}")
    print(f"Enhanced Core-Periphery Analysis for Simulation: {simulation_name}")
...
def build_network(df):
    ...
    for u, v in G.edges():
        ...
        G[u][v]['raw_weight'] = G[u][v]['weight'] * max_weight
...
def main(csv_path, n_runs=5):
    """Enhanced network analysis workflow"""
    try:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Enhanced core-periphery analysis with multi-sample evaluation')
